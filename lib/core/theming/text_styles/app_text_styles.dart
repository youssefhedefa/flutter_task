...
class AppTextStyles extends ThemeExtension<AppTextStyles> {
  ...
  final TextStyle font14MediumSecondaryTextColor;
  ...
  const AppTextStyles({
    ...
    required this.font14MediumSecondaryTextColor,
  ...
  ThemeExtension<AppTextStyles> copyWith({
    ...
    return AppTextStyles(
      ...
      font14MediumSecondaryTextColor: font14MediumSecondaryText ?? this.font14MediumSecondaryTextColor,
  ...
  ThemeExtension<AppTextStyles> lerp(
    ...
    return AppTextStyles(
      ...
      font14MediumSecondaryTextColor: TextStyle.lerp(font14MediumSecondaryTextColor, other.font14MediumSecondaryTextColor, t)!,
